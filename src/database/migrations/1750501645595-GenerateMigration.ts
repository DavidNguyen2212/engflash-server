...
export class GenerateMigration1750501645595 implements MigrationInterface {
    public readonly name = 'GenerateMigration1750501645595'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."user_card_review_logs_event_type_enum" AS ENUM('face', 'learn', 'review')`);
        await queryRunner.query(`ALTER TABLE "user_card_review_logs" ADD "event_type" "public"."user_card_review_logs_event_type_enum" NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "user_card_review_logs" ADD "rating" "public"."user_card_review_logs_rating_enum" NOT NULL`);
